...
cGUIBG              := sciteObj.ResolveProp("tillagoto.gui.bgcolor")
cControlBG          := sciteObj.ResolveProp("tillagoto.gui.controlbgcolor")
cControlFG          := sciteObj.ResolveProp("tillagoto.gui.controlfgcolor")
iControlFontSize    := sciteObj.ResolveProp("tillagoto.gui.font.size") + 0
fControlFont        := sciteObj.ResolveProp("tillagoto.gui.font")
bSortEntries        := sciteObj.ResolveProp("tillagoto.gui.sort.entries") + 0
...
; Necessary for the conditional hotkey/hotstring expression to be registered
    ...
    Gui, Add, Edit, xm ym h%iGUIHeight% w%iGUIWidth% vtxtSearch gtxtSearch_Event hwndhtxtsearch
    ...
    ;sortOpt := bSortEntries ? "Sort" : "" ;Removed this because I've added a sort function to the GUI
    Gui, Add, ListBox, xm y+0 wp r%iGUIHeight% vlblList glblList_Event hwndhlblList +HScroll +256 ;LBS_NOINTEGRALHEIGHT
